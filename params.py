...
PARAM_DEBUG_EN_ZONES        = 1         #zoning info
...
PARAM_MAP_SEED              = '96'       #map seed, should be a string less than or equal to 10 chars

PARAM_MAP_SIZE_X            = 14         #number of x tiles in the map
